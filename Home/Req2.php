             ...
             <div class="row">
                 <div class="col-md-12" data-aos="fade-up" data-aos-delay="">
                     <div class="feature-1 text-center">
                         ...
                         <h3 class="mb-3">Penambahan Data</h3>
...
<div class="container">
  <div class="row">
                   <div class="col-sm-12 col-md-12 col-lg-10">
                     <form action="rqdata_save.php" method="POST">
                       <div class="card">
                           <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12">
                                  <input type="text" class="form-control" name="format" placeholder="Masukkan Data Anda..."> </input>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                                <input type="text" class="form-control" name="jenis" value="Penambahan Data" disabled>
                                <div class="validate"></div>
                      </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                              <input type="nama" class="form-control" name="nama" data-msg="Wajib diisi" placeholder="Masukkan Data Anda...">
