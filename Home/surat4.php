                 ...
                 <div class="col-12">
                     <div class="row justify-content-center">
                         <div class="col-md-7 text-center hero-text">
                             ...
                             <p class="mb-5" data-aos="fade-up" data-aos-delay="100">Surat Keterangan Usaha</p>
                         </div>
                     </div>
                 </div>
             </div>
    ...
    <form action="forms/contact.php" method="post" role="form" class="php-email-form">
        ...
        <div class="row">
            <div class="col-md-12 form-group">
                ...
                <input type="text" class="form-control" id="nametext1" value="Surat Keterangan Usaha" disabled>
            </div>
            <div class="col-md-12 form-group">
