...
<div>
	...
	<div id="isi3">
		...
		<table width="100%">
			<tr>
				<td >Surat keterangan ini dipergunakan untuk memperoleh izin untuk mengadakan acara <a style="text-transform: capitalize;"><u><b><?php echo $row['keperluan']; ?>.</a></u></b></td>
			</tr>
		</table><br>
		<table width="100%">
			<tr>
