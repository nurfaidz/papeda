...
<div>
	<table width="100%">
		<br>
		<div align="center"><u><h4>SURAT KETERANGAN BERKELAKUAN BAIK</h4></u></div>
		<div align="center"><h4>Nomor :&nbsp;&nbsp;&nbsp;<?php echo $row['no_surat']; ?></h4></div>
	</table>
	<br>
	<div>
		<table width="100%">
		...
		<table width="100%">
			<tr>
				<td >Menurut pengamatan kami orang tersebut di atas, baik langsung maupun tidak langsung, tidak pernah tersangkut urusan polisi. Adapun surat keterangan ini dibuat untuk :</td>
			</tr>
		</table><br>
		<table width="100%" style="text-transform: capitalize;">
			<tr>
				<td style="text-align:center;"><b><u><?php echo $row['keperluan']; ?></u></b></td>
			</tr>
		</table><br>
			<tr>
