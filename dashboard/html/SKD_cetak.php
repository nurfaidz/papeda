...
<div>
	<table width="100%">
		<br>
		<div align="center"><u><h4>SURAT PERMOHONAN SKCK</h4></u></div>
	...
	<div>
		...
		<table width="100%">
			<tr>
				<td >Orang tersebut diatas benar-benar penduduk kami Dusun. Bahwa nama yang bersangkutan benar berdomisili di <?php echo $row['alamat'];?>.</td>
			</tr>
		</table><br>
			<tr>
				<td >Demikian surat ini dibuat dengan sebenar-benarnya dan untuk dipergunakan sebagaimana mestinya.</td>
			</tr><br>
	</div>
	<br>
	<table width="100%" style="text-transform: capitalize;">
